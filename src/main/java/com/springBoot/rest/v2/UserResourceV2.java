package com.springBoot.rest.v2;
...
public class UserResourceV2 {
    private static final Logger LOGGER = LoggerFactory.getLogger(UserResourceV2.class);
    private static Validator validator = Validation.buildDefaultValidatorFactory().getValidator();

    @GET
    @Path("v2/users/{id}")
    @ApiOperation(value = "Gets an User resource. Version 2 - (version in URL)", response = User.class)
    @ApiResponses(value = {
    ...
    @POST
    @Path("v2/users")
    @ApiOperation(value = "Creates User resource. Version 2 - (version in URL)", response = User.class)
    @ApiResponses(value = {
